...
void Event::AddParticle(UInt_t pid, Short_t charge, Float_t px, Float_t py, Float_t pz, Float_t dedx, Float_t dedx_vtpc1, Float_t dedx_vtpc2, Float_t dedx_mtpc, UInt_t nclusters, Point *clusters_positions)
{
	new ((*fParticles) [fNpa]) Particle(pid, charge, px, py, pz, dedx, dedx_vtpc1, dedx_vtpc2, dedx_mtpc, nclusters, clusters_positions);
	fNpa++;
